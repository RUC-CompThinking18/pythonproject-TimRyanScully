...
Room = Location("Room", "\n\nYou slowly get out of bed with a groan. Streaching upright and punching the alarm clock, you see that the time it is. You need to get ready for work. ", "Go outside", "Go to the bathroom", "Get dressed", "Go back to bed")
...
def GameLoop(Location, index):
    ...
    if (Location.selected == Location.optionA):
        ...
        if (index < 5):
            ...
            GameLoop(Locations[index + 1], (index + 1)) #Exit one Location and enter another.
